...
namespace OodlesParty.Editor
{
    class CharacterBuilder : ScriptableWizard
    {
        ...
        bool ApplyOodlesCharacterByBone(OodlesParty.OodlesCharacter pc, int id, Animator ragdoll, Animator anim, HumanBodyBones bone)
        {
            ...
            if (bone == HumanBodyBones.LeftHand)
            {
                ...
                hf.handSide = OodlesParty.HandSide.HandLeft;
            ...
            else if (bone == HumanBodyBones.RightHand)
            {
                ...
                hf.oodlesCharacter = pc;
                hf.handSide = OodlesParty.HandSide.HandRight;
                EditorUtility.SetDirty(hf);
            }
        ...
        public OodlesCharacter OnCreateOodlesCharacter()
        {
            ...
            Mirror.NetworkIdentity networkIdentity = pelvis.transform.root.gameObject.AddComponent<Mirror.NetworkIdentity>();
            OodlesParty.OodlesCharacter pc = pelvis.transform.root.gameObject.AddComponent<OodlesParty.OodlesCharacter>();  //Joint Match class added to root object
            ...
            pc.joints = new ConfigurableJoint[(int)OodlesParty.OodlesCharacter.BodyPart.BP_MAX];
            ...
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_Pelvis, ragdollAnimator, staticAnimator, HumanBodyBones.Hips);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_UpLegLeft, ragdollAnimator, staticAnimator, HumanBodyBones.LeftUpperLeg);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_LegLeft, ragdollAnimator, staticAnimator, HumanBodyBones.LeftLowerLeg);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_FootLeft, ragdollAnimator, staticAnimator, HumanBodyBones.LeftFoot);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_UpLegRight, ragdollAnimator, staticAnimator, HumanBodyBones.RightUpperLeg);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_LegRight, ragdollAnimator, staticAnimator, HumanBodyBones.RightLowerLeg);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_FootRight, ragdollAnimator, staticAnimator, HumanBodyBones.RightFoot);

            bool findChest = ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_Spine, ragdollAnimator, staticAnimator, HumanBodyBones.Chest);

            if (!findChest)
            {
                ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_Spine, ragdollAnimator, staticAnimator, HumanBodyBones.Spine);
            }

            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_UpArmLeft, ragdollAnimator, staticAnimator, HumanBodyBones.LeftUpperArm);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_ArmLeft, ragdollAnimator, staticAnimator, HumanBodyBones.LeftLowerArm);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_HandLeft, ragdollAnimator, staticAnimator, HumanBodyBones.LeftHand);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_Head, ragdollAnimator, staticAnimator, HumanBodyBones.Head);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_UpArmRight, ragdollAnimator, staticAnimator, HumanBodyBones.RightUpperArm);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_ArmRight, ragdollAnimator, staticAnimator, HumanBodyBones.RightLowerArm);
            ApplyOodlesCharacterByBone
                (pc, offset + (int)OodlesParty.OodlesCharacter.BodyPart.BP_HandRight, ragdollAnimator, staticAnimator, HumanBodyBones.RightHand);

            NetworkedOodlesCharacter npc = pc.gameObject.AddComponent<NetworkedOodlesCharacter>();
            npc._identity = networkIdentity;
            npc.oodlesCharacter = pc;
            pc.gameObject.AddComponent<NetworkedOodlesCharacterMessenger>();
            OodlesCharacterPrediction pcp = pc.gameObject.AddComponent<OodlesCharacterPrediction>();
            pcp._identity = networkIdentity;
            CharacterProperty pp = pc.gameObject.AddComponent<CharacterProperty>();
            pp.playerteam = 2;
            NetworkPlayer np = pc.gameObject.AddComponent<NetworkPlayer>();
        ...
        GameObject InitialiseCharacterObject()
        {
            ...
            ActiveRagdollRoot.name = "Oodles Network Player";
