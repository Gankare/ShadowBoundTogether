...
namespace OodlesParty.Editor
    { 
    public class OodlesPartyToolGUI : EditorWindow
    {
        ...
        [MenuItem("Window/OodlesPartyCharacter")]
        public static void ShowWindow()
        {
            GetWindow<OodlesPartyToolGUI>("OodlesParty Character");
        }
        ...
        void OnGUICreate()
        {
            ...
            GUILayout.FlexibleSpace();
            GUILayout.Label("Character Builder For Oodles Party", EditorStyles.miniLabel);
