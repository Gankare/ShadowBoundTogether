...
{ 
    ...
    public class AnimatorHelper : MonoBehaviour {
        ...
        public float ChestMaxLookWeight { get; set; } = 1.0f;
        ...
        public bool SimulateIK { get; set; }
        ...
        private void OnAnimatorIK(int layerIndex) {
            ...
            if (!SimulateIK) return;

            // Look
            _animator.SetLookAtWeight(LookIKWeight, 1/*((LeftArmIKWeight + RightArmIKWeight) / 2) * ChestMaxLookWeight*/, 1, 1, 0);
